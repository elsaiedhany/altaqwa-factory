...
export const metadata = {
  title: `معرض الصور | أرقى تصاميم المطابخ والألوميتال`,
  description: "تصفح أكبر معرض صور لمطابخ ألوميتال وأكريليك في مصر من تنفيذ مصنع التقوى. صور واقعية تعكس دقة التشطيب وفخامة التنفيذ الهندسي لعملائنا."
};
