...
export const metadata = {
  title: `سابقة أعمالنا | مشاريع مطابخ وألوميتال تم تنفيذها بدقة`,
  description: "استعرض معرض مشاريعنا الحقيقية. صور مطابخ ألوميتال وأكريليك تم تنفيذها بأعلى معايير الجودة لعملائنا في مختلف أنحاء مصر تحت إشراف هندسي كامل."
};
